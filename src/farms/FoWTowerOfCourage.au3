...
DictItem($fow_toc_move_options, 'defendFunction',  CastFowToCBuffs)
DictItem($fow_toc_move_options, 'moveTimeOut',  5 * 60 * 1000)
DictItem($fow_toc_move_options, 'randomFactor',  25)
DictItem($fow_toc_move_options, 'hosSkillSlot',  $FOW_TOC_HEART_OF_SHADOW)
DictItem($fow_toc_move_options, 'deathChargeSkillSlot',  $FOW_TOC_DEATH_CHARGE)
DictItem($fow_toc_move_options, 'openChests',  False)
