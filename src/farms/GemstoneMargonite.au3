...
DictItem($margonite_move_options, 'defendFunction',  MargoniteDefend)
DictItem($margonite_move_options, 'moveTimeOut',  100 * 1000)
DictItem($margonite_move_options, 'randomFactor',  25)
DictItem($margonite_move_options, 'hosSkillSlot',  0)
DictItem($margonite_move_options, 'deathChargeSkillSlot',  $MARGONITE_DEATHS_CHARGE)
DictItem($margonite_move_options, 'openChests',  False)

Global $margonite_move_options_elementalist = CloneDictMap($margonite_move_options)
DictItem($margonite_move_options_elementalist, 'deathChargeSkillSlot',  0)
