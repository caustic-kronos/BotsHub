...
Func MinotaursFarm($STATUS)
	If Not $NORN_FARM_SETUP Then SetupMinotaursFarm()
...
Func FarmMinotaurs()
	...
	Local Static $minotaurs[12][3] = [ _ ; 12 groups to vanquish
		[18870, -6, 'Minotaur group 1'], _
		[18828, 2201, 'Minotaur group 2'], _
		[17106, 1459, 'Minotaur group 3'], _
		[14424, 134, 'Minotaur group 4'], _
		[10852, 1967, 'Minotaur group 5'], _
		[10704, 6422, 'Minotaur group 6'], _
		[9081, 7155, 'Minotaur group 7'], _
		[8755, 10512, 'Minotaur group 8'], _
		[12348, 10156, 'Minotaur group 9'], _
		[7001, 8789, 'Minotaur group 10'], _
		[5155, 8838, 'Minotaur group 11'], _
		[2616, 7615, 'Minotaur group 12'] _
	]
