...
Func ClearTunnelsOfTheForsakenFloor3()
	...
	Info('Open dungeon door')
		...
		For $i = 1 To 2
			...
			ActionInteract()
		Next
		MoveAggroAndKillInRange(-7771, -6279, '16', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-11025, -7480, '17', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-12939, -8238, '18', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		RandomSleep(2000)
		MoveAggroAndKillInRange(-13836, -8918, '19', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-16021, -8601, '20', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		RandomSleep(2000)
