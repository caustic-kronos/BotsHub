...
Func ClearTunnelsOfTheForsakenFloor1()
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), -8684, 4580, $RANGE_AREA)
		...
		MoveAggroAndKillInRange(-11660, -7585, '3', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-7836, -9115, '4', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)

		Local $questNPC = GetNearestNPCToCoords(-7400, -9462)
		TakeQuest($questNPC, $ID_QUEST_THE_DREAMER_AND_THE_ZEALOT, 0x85B501)

		MoveAggroAndKillInRange(-9672, -3286, '5', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		PickUpElementalKeystone()
		MoveAggroAndKillInRange(-11186, -1788, '6', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		PickUpElementalKeystone()
		MoveAggroAndKillInRange(-10727, -304, '7', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		PickUpElementalKeystone()
		MoveAggroAndKillInRange(-8618, 3132, '8', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		PickUpElementalKeystone()
...
Func ClearTunnelsOfTheForsakenFloor2()
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), -16748, 5350, 1250)
		...
		UseMoraleConsumableIfNeeded()
		UseSummoningStone()
		MoveAggroAndKillInRange(-2196, 12191, '1', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(1228, 16292, '2', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		...
		MoveAggroAndKillInRange(-2584, 21152, '5', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-3558, 21554, '6', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-3788, 21873, '7', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-6974, 20808, '8', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-9017, 21345, '9', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-10769, 20331, '10', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-12465, 20092, '11', $RANGE_NEARBY)
		MoveAggroAndKillInRange(-14464, 19742, '12', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-16238, 17982, '13', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-16724, 15846, '14', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-13865, 17135, '15', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-12848, 18506, '16', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-10956, 19044, '17', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-7875, 18959, '18', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-6272, 17188, '19', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-5910, 14892, '20', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-7177, 13320, '21', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-10482, 14259, '22', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		RandomSleep(5000)
		MoveAggroAndKillInRange(-10816, 15686, '23', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-12402, 15310, '24', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-14553, 12670, '25', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-16047, 10162, '26', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-16759, 7708, '27', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-16748, 5350, '28', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
	WEnd
	If IsRunFailed() Then Return $FAIL
...
Func ClearTunnelsOfTheForsakenFloor3()
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), -10264, -4463, 1250)
		...
		MoveAggroAndKillInRange(-16397, -3496, '4', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-15176, -3768, '5', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-13875, -4543, '6', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		...
		MoveAggroAndKillInRange(-14111, -6232, '7', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		Sleep(2000)
		MoveAggroAndKillInRange(-13875, -4543, '8', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-12599, -5454, '9', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		Sleep(4000)
		PickUpItems()
		MoveAggroAndKillInRange(-10724, -3552, '10', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
	WEnd
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), -15949, -8561, 1250)
		...
		UseMoraleConsumableIfNeeded()
		UseSummoningStone()
		MoveAggroAndKillInRange(-9820, -2108, '11', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
	...
	Info('Open dungeon door')
		...
		For $i = 1 To 2
			...
			ActionInteract()
		Next
		MoveAggroAndKillInRange(-7771, -6279, '15', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-11025, -7480, '16', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-12939, -8238, '17', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		RandomSleep(2000)
		MoveAggroAndKillInRange(-13836, -8918, '18', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		MoveAggroAndKillInRange(-16021, -8601, '19', $TUNNELS_OF_THE_FORSAKEN_AGGRO_RANGE)
		RandomSleep(2000)
