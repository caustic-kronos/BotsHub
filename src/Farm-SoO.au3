...
Func ClearSoOFloor1()
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), 9232, 11483, 1250)
		If DetectStuck('SoO Floor 1 - First loop') == $FAIL Then Return $FAIL
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), 16134, 11781, 1250)
		If DetectStuck('SoO Floor 1 - Second loop') == $FAIL Then Return $FAIL
		UseMoraleConsumableIfNeeded()
		; too close to walls
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), 14750, 5250, 1250)
		If DetectStuck('SoO Floor 1 - Third loop') == $FAIL Then Return $FAIL
		UseMoraleConsumableIfNeeded()
	...
	While Not IsRunFailed() And Not $mapLoaded
		If DetectStuck('SoO Floor 1 - Opening door') == $FAIL Then Return $FAIL
...
Func ClearSoOFloor2()
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), -11000, -6000, 1250)
		If DetectStuck('SoO Floor 2 - First Room') == $FAIL Then Return $FAIL
		UseMoraleConsumableIfNeeded()
		Info('Getting blessing')
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), -17500, -9500, 1250)
		If DetectStuck('SoO Floor 2 - Second Room') == $FAIL Then Return $FAIL
	...
	Local $mapLoaded = False
	While Not IsRunFailed() And Not $mapLoaded
		If DetectStuck('SoO Floor 2 - Opening door') == $FAIL Then Return $FAIL
		Info('Open dungeon door')
		ClearTarget()
...
Func ClearSoOFloor3()
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), 1100, 7100, 1250)
		If DetectStuck('SoO Floor 3 - First loop') == $FAIL Then Return $FAIL
		UseMoraleConsumableIfNeeded()
		Info('Getting blessing')
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), -8650, 9200, 1250)
		If DetectStuck('SoO Floor 3 - Second loop') == $FAIL Then Return $FAIL
		UseMoraleConsumableIfNeeded()
	...
	While Not IsRunFailed() And $questState <> 3
		If DetectStuck('SoO Floor 3 - Third loop') == $FAIL Then Return $FAIL
...
Func DetectStuck($stuckLocation)
