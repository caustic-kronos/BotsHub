...
Func InitialSetupLDOA()
	...
	TakeQuest($questNPC, $ID_QUEST_WAR_PREPARATIONS3, $ID_DIALOG_ACCEPT_QUEST_WAR_PREPARATIONS)
	...
	TakeQuestReward($questNPC, $ID_QUEST_WAR_PREPARATIONS3, $ID_DIALOG_FINISH_QUEST_WAR_PREPARATIONS)
