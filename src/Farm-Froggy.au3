...
Func ClearFroggyFloor1()
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), 6078, 4483, 1250)
		If DetectStuck('Froggy Floor 1 - First loop') == $FAIL Then Return $FAIL
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), -1501, -8590, 1250)
		If DetectStuck('Froggy Floor 1 - Second loop') == $FAIL Then Return $FAIL
		UseMoraleConsumableIfNeeded()
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), 7171, -17934, 1250)
		If DetectStuck('Froggy Floor 1 - Third loop') == $FAIL Then Return $FAIL
		UseMoraleConsumableIfNeeded()
	...
	Local $mapLoaded = False
	While Not $mapLoaded
		If DetectStuck('Froggy Floor 1 - Getting through portal') == $FAIL Then Return $FAIL
		MoveTo(7171, -17934)
		Move(7600, -19100)
		RandomSleep(2000)
...
Func ClearFroggyFloor2()
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), -719, 11140, 1250)
		If DetectStuck('Froggy Floor 2 - First loop') == $FAIL Then Return $FAIL
		Info('Getting blessing')
		MoveTo(-11072, -5522)
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), 8398, 4358, 1250)
		If DetectStuck('Froggy Floor 2 - Second loop') == $FAIL Then Return $FAIL
		UseMoraleConsumableIfNeeded()
	...
	While Not IsRunFailed() And Not IsAgentInRange(GetMyAgent(), 19597, -11553, 1250)
		If DetectStuck('Froggy Floor 2 - Third loop') == $FAIL Then Return $FAIL
		UseMoraleConsumableIfNeeded()
	...
	While Not IsRunFailed() And $questState <> 3
		If DetectStuck('Froggy Floor 2 - Fourth loop') == $FAIL Then Return $FAIL
		Info('------------------------------------')
		Info('Boss area')
		UseMoraleConsumableIfNeeded()
