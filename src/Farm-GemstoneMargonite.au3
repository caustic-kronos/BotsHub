...
Func CastBondsMargoniteFarm()
	...
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_BalthazarSpirit, GetMyAgent()) ; costs 10 energy
	Sleep(2000) ; wait cast time of Balthazar's Spirit
	Sleep(10000) ; wait until energy is recovered, should recover 10 energy with 3 energy pips
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_WatchfulSpirit, GetMyAgent()) ; costs 15 energy
	Sleep(1000) ; wait cast time of Watchful Spirit
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_BlessedSignet) ; recover 6 hero energy
	Sleep(2000) ; wait cast time of Blessed Signet
	Sleep(12000) ; wait until Blessed signet is recharged, should recover 8 energy with 2 energy pips
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_LifeBarrier, GetMyAgent()) ; costs 15 energy, 1 energy should be recovered during casting, energy should be maxed
	Sleep(2000) ; wait cast time of Life Barrier
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_BlessedSignet) ; recover 9 hero energy
	Sleep(2000) ; wait cast time of Blessed Signet
	Sleep(15000) ; wait until Blessed signet is recharged, should recover 5 energy with 1 energy pip
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_LifeBond, GetMyAgent()) ; costs 10 energy
	Sleep(2000) ; wait cast time of Life Bond
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_BlessedSignet) ; recover 11 hero energy, energy should be maxed
	Sleep(2000) ; wait cast time of Blessed Signet
	Sleep(10000) ; wait until Blessed signet is recharged, 0 pips
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_VitalBLessing, GetMyAgent()) ; costs 10 energy
	Sleep(2000) ; wait cast time of Vital Blessing
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_BlessedSignet) ; recover 11 hero energy
	Sleep(2000) ; wait cast time of Blessed Signet
	Sleep(10000) ; wait until Blessed signet is recharged, around 3 energy lost with -1 pip
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_BalthazarSpirit, GetAgentByID($MargoniteHeroAgentID)) ; costs 10 energy
	Sleep(2000) ; wait cast time of Balthazar's Spirit
	UseHeroSkill($MargoniteHeroIndex, $Margonite_Hero_BlessedSignet) ; recover 11 hero energy, -2 pips, but energy will be recovered soon with balthazar's aura
