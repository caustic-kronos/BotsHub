...
Func CreateMobsPriorityMap()
	...
	$map[$WarSupply_Peacekeeper_1]	= 6
	$map[$WarSupply_Peacekeeper_2]	= 6
	$map[$WarSupply_Peacekeeper_3]	= 6
	$map[$WarSupply_Peacekeeper_4]	= 6
	$map[$WarSupply_Peacekeeper_5]	= 6
	$map[$WarSupply_Enforcer_1]		= 6
	$map[$WarSupply_Enforcer_2]		= 6
	$map[$WarSupply_Enforcer_3]		= 6
	$map[$WarSupply_Enforcer_4]		= 6
	$map[$WarSupply_Enforcer_5]		= 6
	$map[$WarSupply_Knight_1] 		= 7
	$map[$WarSupply_Knight_2] 		= 7
	$map[$WarSupply_Zealot_1] 		= 7
	$map[$WarSupply_Zealot_2] 		= 7
	$map[$WarSupply_Zealot_3] 		= 7
	$map[$WarSupply_Zealot_4] 		= 7
	$map[$WarSupply_Zealot_5] 		= 7
	$map[$WarSupply_Champion_1]		= 7
	$map[$WarSupply_Champion_2]		= 7
	$map[$WarSupply_Champion_3]		= 7
	$map[$WarSupply_Seeker_1] 		= 8
	$map[$WarSupply_Seeker_2] 		= 8
	$map[$WarSupply_Seeker_3] 		= 8
	$map[$WarSupply_Seeker_4] 		= 8
	$map[$WarSupply_Seeker_5] 		= 8
	$map[$WarSupply_Seeker_6] 		= 8
	$map[$WarSupply_Seeker_7] 		= 8
	$map[$WarSupply_Seeker_8] 		= 8
	$map[$WarSupply_Scout_1]		= 8
	$map[$WarSupply_Scout_2]		= 8
	$map[$WarSupply_Scout_3]		= 8
	$map[$WarSupply_Scout_4]		= 8
	$map[$WarSupply_Marksman_1]		= 8
	$map[$WarSupply_Marksman_2]		= 8
	$map[$WarSupply_Marksman_3]		= 8
