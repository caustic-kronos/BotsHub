...
Local $STRUCT_INHERENT_FIRE_MAGIC_HCT = '0A141822'
Local $STRUCT_INHERENT_FIRE_MAGIC_HSR = '0A149823'
Local $STRUCT_INHERENT_WATER_MAGIC_HCT = '0B141822'
Local $STRUCT_INHERENT_WATER_MAGIC_HSR = '0B149823'
Local $STRUCT_INHERENT_AIR_MAGIC_HCT = '08141822'
Local $STRUCT_INHERENT_AIR_MAGIC_HSR = '08149823'
Local $STRUCT_INHERENT_EARTH_MAGIC_HCT = '09141822'
Local $STRUCT_INHERENT_EARTH_MAGIC_HSR = '09149823'
Local $STRUCT_INHERENT_ENERGY_STORAGE_HCT = '0C141822'
Local $STRUCT_INHERENT_ENERGY_STORAGE_HSR = '0C149823'
Local $STRUCT_INHERENT_SMITING_PRAYERS_HCT = '0E141822'
Local $STRUCT_INHERENT_SMITING_PRAYERS_HSR = '0E149823'
Local $STRUCT_INHERENT_DIVINE_FAVOR_HCT = '10141822'
Local $STRUCT_INHERENT_DIVINE_FAVOR_HSR = '10149823'
Local $STRUCT_INHERENT_HEALING_PRAYERS_HCT = '0D141822'
Local $STRUCT_INHERENT_HEALING_PRAYERS_HSR = '0D149823'
Local $STRUCT_INHERENT_PROTECTION_PRAYERS_HCT = '0F141822'
Local $STRUCT_INHERENT_PROTECTION_PRAYERS_HSR = '0F149823'
Local $STRUCT_INHERENT_CHANNELING_MAGIC_HCT = '22141822'
Local $STRUCT_INHERENT_CHANNELING_MAGIC_HSR = '22149823'
Local $STRUCT_INHERENT_RESTORATION_MAGIC_HCT = '21141822'
Local $STRUCT_INHERENT_RESTORATION_MAGIC_HSR = '21149823'
Local $STRUCT_INHERENT_COMMUNING_HCT = '20141822'
Local $STRUCT_INHERENT_COMMUNING_HSR = '20149823'
Local $STRUCT_INHERENT_SPAWNING_POWER_HCT = '24141822'
Local $STRUCT_INHERENT_SPAWNING_POWER_HSR = '24149823'
Local $STRUCT_INHERENT_ILLUSION_MAGIC_HCT = '01149823'
Local $STRUCT_INHERENT_ILLUSION_MAGIC_HSR = '01141822'
Local $STRUCT_INHERENT_DOMINATION_MAGIC_HCT = '02141822'
Local $STRUCT_INHERENT_DOMINATION_MAGIC_HSR = '02149823'
Local $STRUCT_INHERENT_INSPIRATION_MAGIC_HCT = '03149823'
Local $STRUCT_INHERENT_INSPIRATION_MAGIC_HSR = '03141822'
Local $STRUCT_INHERENT_DEATH_MAGIC_HCT = '05141822'
Local $STRUCT_INHERENT_DEATH_MAGIC_HSR = '05149823'
Local $STRUCT_INHERENT_BLOOD_MAGIC_HCT = '04149823'
Local $STRUCT_INHERENT_BLOOD_MAGIC_HSR = '04141822'
Local $STRUCT_INHERENT_SOUL_REAPING_HCT = '06149823'
Local $STRUCT_INHERENT_SOUL_REAPING_HSR = '06141822'
Local $STRUCT_INHERENT_CURSES_HCT = '07149823'
Local $STRUCT_INHERENT_CURSES_HSR = '07141822'
...
Local $STRUCT_INHERENT_OF_ILLUSION_MAGIC = '0118240'
...
Local $ValuableModsByOSWeaponType = CreateValuableModsByOSWeaponTypeMap()
Local $ValuableModsByWeaponType = CreateValuableModsByWeaponTypeMap()
Local $PerfectModsByWeaponType = CreatePerfectModsByOSWeaponTypeMap()
...
Func CreateValuableModsByOSWeaponTypeMap()
	...
	Local $Wand_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_MESMER, $STRUCT_MOD_OF_THE_MONK, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_DERVISH]
	Local $Dagger_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_WARRIOR, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_ASSASSIN, $STRUCT_MOD_OF_THE_DERVISH]
	Local $Staff_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_MESMER, $STRUCT_MOD_OF_THE_MONK, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_DERVISH, _
	...
	Local $Bow_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_WARRIOR, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_ASSASSIN, $STRUCT_MOD_OF_THE_DERVISH, _
		$STRUCT_MOD_OF_CHARRSLAYING, $STRUCT_MOD_OF_TROLLSLAYING, $STRUCT_MOD_OF_GIANT_SLAYING, $STRUCT_MOD_OF_DWARF_SLAYING, $STRUCT_MOD_OF_TENGU_SLAYING] ; Personal collection
	Local $Axe_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_WARRIOR, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_ASSASSIN, $STRUCT_MOD_OF_THE_DERVISH, _
		$STRUCT_MOD_OF_CHARRSLAYING, $STRUCT_MOD_OF_TROLLSLAYING, $STRUCT_MOD_OF_GIANT_SLAYING, $STRUCT_MOD_OF_DWARF_SLAYING, $STRUCT_MOD_OF_TENGU_SLAYING] ; Personal collection
	Local $Hammer_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_WARRIOR, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_ASSASSIN, $STRUCT_MOD_OF_THE_DERVISH, _
		$STRUCT_MOD_OF_CHARRSLAYING, $STRUCT_MOD_OF_TROLLSLAYING, $STRUCT_MOD_OF_GIANT_SLAYING, $STRUCT_MOD_OF_DWARF_SLAYING, $STRUCT_MOD_OF_TENGU_SLAYING] ; Personal collection
	Local $Sword_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_WARRIOR, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_ASSASSIN, $STRUCT_MOD_OF_THE_DERVISH, _
		$STRUCT_MOD_OF_CHARRSLAYING, $STRUCT_MOD_OF_TROLLSLAYING, $STRUCT_MOD_OF_GIANT_SLAYING, $STRUCT_MOD_OF_DWARF_SLAYING, $STRUCT_MOD_OF_TENGU_SLAYING] ; Personal collection
...
Func CreateValuableModsByWeaponTypeMap()
	...
	Local $Bow_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_WARRIOR, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_ASSASSIN, $STRUCT_MOD_OF_THE_DERVISH]
	Local $Axe_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_WARRIOR, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_ASSASSIN, $STRUCT_MOD_OF_THE_DERVISH]
	Local $Hammer_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_WARRIOR, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_ASSASSIN, $STRUCT_MOD_OF_THE_DERVISH]
	Local $Sword_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_WARRIOR, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_ASSASSIN, $STRUCT_MOD_OF_THE_DERVISH]
	Local $Dagger_Mods_Array = [$STRUCT_MOD_OF_THE_NECROMANCER, $STRUCT_MOD_OF_THE_ELEMENTALIST, $STRUCT_MOD_OF_THE_WARRIOR, $STRUCT_MOD_OF_THE_RANGER, $STRUCT_MOD_OF_THE_RITUALIST, $STRUCT_MOD_OF_THE_ASSASSIN, $STRUCT_MOD_OF_THE_DERVISH]
