...
Global Const $TROPHIES_ARRAY[]	= [ _
	...
	$ID_SKALE_FIN, $ID_CHUNK_OF_DRAKE_FLESH, $ID_DIAMOND_DJINN_ESSENCE, $ID_RUBY_DJINN_ESSENCE, $ID_SAPPHIRE_DJINN_ESSENCE, $ID_WATER_DJINN_ESSENCE, _
...
Global Const $BONES_TROPHIES_ARRAY[]			= [ $ID_GARGOYLE_SKULL, $ID_SKELETAL_LIMB, $ID_ONI_TALON, $ID_ONI_CLAW, _
