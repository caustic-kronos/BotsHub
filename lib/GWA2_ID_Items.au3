...
Global Const $TROPHIES_ARRAY[]	= [ _
	$ID_SPIDER_WEB_PRESEARING, $ID_CHARR_HIDE, $ID_SPIDER_LEG, $ID_CHARR_CARVING, $ID_ICY_LODESTONE, $ID_DULL_CARAPACE, $ID_GARGOYLE_SKULL, $ID_WORN_BELT, $ID_UNNATURAL_SEED, $ID_SKELETAL_LIMB, $ID_ENCHANTED_LODESTONE, _
	$ID_GRAWL_NECKLACE, $ID_BAKED_HUSK, $ID_SPIKED_CREST, $ID_HARDENED_HUMP, $ID_MERGOYLE_SKULL, $ID_GLOWING_HEART, $ID_FOREST_MINOTAUR_HORN, $ID_SHADOWY_REMNANT, $ID_ABNORMAL_SEED, $ID_BOG_SKALE_FIN, $ID_FEATHERED_CAROMI_SCALP, _
	$ID_SHRIVELED_EYE, $ID_DUNE_BURROWER_JAW, $ID_LOSARU_MANE, $ID_BLEACHED_CARAPACE, $ID_TOPAZ_CREST, $ID_ENCRUSTED_LODESTONE, $ID_MASSIVE_JAWBONE, $ID_IRIDESCENT_GRIFFON_WING, $ID_DESSICATED_HYDRA_CLAW, $ID_MINOTAUR_HORN, _
	$ID_JADE_MANDIBLE, $ID_FORGOTTEN_SEAL, $ID_WHITE_MANTLE_EMBLEM, $ID_WHITE_MANTLE_BADGE, $ID_MURSAAT_TOKEN, $ID_EBON_SPIDER_LEG, $ID_ANCIENT_EYE, $ID_BEHEMOTH_JAW, $ID_MAGUUMA_MANE, $ID_THORNY_CARAPACE, $ID_TANGLED_SEED, _
	$ID_MOSSY_MANDIBLE, $ID_JUNGLE_SKALE_FIN, $ID_JUNGLE_TROLL_TUSK, $ID_OBSIDIAN_BURROWER_JAW, $ID_DEMONIC_FANG, $ID_PHANTOM_RESIDUE, $ID_GRUESOME_STERNUM, $ID_DEMONIC_REMAINS, $ID_STORMY_EYE, $ID_SCAR_BEHEMOTH_JAW, _
	$ID_FETID_CARAPACE, $ID_SINGED_GARGOYLE_SKULL, $ID_GHOSTLY_REMAINS, $ID_GRUESOME_RIBCAGE, $ID_RAWHIDE_BELT, $ID_LEATHERY_CLAW, $ID_SCORCHED_SEED, $ID_SCORCHED_LODESTONE, $ID_ORNATE_GRAWL_NECKLACE, $ID_SHIVERPEAK_MANE, _
	$ID_FROSTFIRE_FANG, $ID_ICY_HUMP, $ID_HUGE_JAWBONE, $ID_FROSTED_GRIFFON_WING, $ID_FRIGID_HEART, $ID_CURVED_MINTAUR_HORN, $ID_AZURE_REMAINS, $ID_ALPINE_SEED, $ID_FEATHERED_AVICARA_SCALP, $ID_INTRICATE_GRAWL_NECKLACE, _
	$ID_MOUNTAIN_TROLL_TUSK, $ID_STONE_SUMMIT_BADGE, $ID_MOLTEN_CLAW, $ID_DECAYED_ORR_EMBLEM, $ID_IGNEOUS_SPIDER_LEG, $ID_MOLTEN_EYE, $ID_FIERY_CREST, $ID_IGNEOUS_HUMP, $ID_UNCTUOUS_REMAINS, $ID_MAHGO_CLAW, $ID_MOLTEN_HEART, _
	$ID_CORROSIVE_SPIDER_LEG, $ID_UMBRAL_EYE, $ID_SHADOWY_CREST, $ID_DARK_REMAINS, $ID_GLOOM_SEED, $ID_UMBRAL_SKELETAL_LIMB, $ID_SHADOWY_HUSK, $ID_ENSLAVEMENT_STONE, $ID_KURZICK_BAUBLE, $ID_PLAGUE_IDOL, $ID_COPPER_CRIMSON_SKULL_COIN, _
	$ID_GOLD_CRIMSON_SKULL_COIN, $ID_JADE_BRACELET, $ID_LUXON_PENDANT, $ID_BONE_CHARM, $ID_TRUFFLE, $ID_SKULL_JUJU, $ID_MANTIS_PINCER, $ID_STONE_HORN, $ID_KEEN_ONI_CLAW, $ID_DREDGE_INCISOR, $ID_DRAGON_ROOT, $ID_STONE_CARVING, _
	$ID_WARDEN_HORN, $ID_PULSATING_GROWTH, $ID_FORGOTTEN_TRINKET_BOX, $ID_AUGMENTED_FLESH, $ID_PUTRID_CYST, $ID_MANTID_PINCER, $ID_NAGA_HIDE, $ID_NAGA_PELT, $ID_FEATHERED_CREST, $ID_FEATHERED_SCALP, $ID_KAPPA_HATCHLING_SHELL, _
	$ID_STOLEN_SUPPLIES, $ID_BLACK_PEARL, $ID_ROT_WALLOW_TUSK, $ID_KRAKEN_EYE, $ID_AZURE_CREST, $ID_KIRIN_HORN, $ID_KEEN_ONI_TALON, $ID_NAGA_SKIN, $ID_GUARDIAN_MOSS, $ID_ARCHAIC_KAPPA_SHELL, $ID_STOLEN_PROVISIONS, $ID_SOUL_STONE, _
	$ID_VERMIN_HIDE, $ID_VENERABLE_MANTID_PINCER, $ID_CELESTIAL_ESSENCE, $ID_ANCIENT_KAPPA_SHELL, $ID_MOON_SHELL, $ID_STOLEN_GOODS, $ID_STOLEN_SHIPMENT, $ID_COPPER_SHILLING, $ID_GOLD_DOUBLOON, $ID_SILVER_BULLION_COIN, $ID_DEMONIC_RELIC, _
	$ID_MARGONITE_MASK, $ID_KOURNAN_PENDANT, $ID_MUMMY_WRAPPING, $ID_SANDBLASTED_LODESTONE, $ID_INSCRIBED_SHARD, $ID_DUSTY_INSECT_CARAPACE, $ID_GIANT_TUSK, $ID_RINKHAL_TALON, $ID_FLEDGLING_SKREE_WING, $ID_INSECT_APPENDAGE, _
	$ID_JUVENILE_TERMITE_LEG, $ID_SENTIENT_ROOT, $ID_SENTIENT_SEED, $ID_SKALE_TOOTH, $ID_SKALE_CLAW, $ID_SKELETON_BONE, $ID_COBALT_TALON, $ID_SKREE_WING, $ID_INSECT_CARAPACE, $ID_SENTIENT_LODESTONE, $ID_IMMOLATED_DJINN_ESSENCE, _
	$ID_ROARING_ETHER_CLAW, $ID_SPIDER_WEB, $ID_LUMINOUS_STONE, $ID_ROARING_ETHER_HEART, $ID_PILLAGED_GOODS, $ID_MALODOROUS_MASS, $ID_MANDRAGOR_HUSK, $ID_MANDRAGOR_CARAPACE, $ID_MANDRAGOR_SWAMPROOT, $ID_BEHEMOTH_HIDE, $ID_GEODE, _
	$ID_HUNTING_MINOTAUR_HORN, $ID_MANDRAGOR_ROOT, $ID_ETHEREAL_GARMENT, $ID_RED_IRIS_FLOWER, $ID_IBOGA_PETAL, $ID_SKALE_FIN, $ID_CHUNK_OF_DRAKE_FLESH, $ID_DIAMOND_DJINN_ESSENCE, $ID_RUBY_DJINN_ESSENCE, $ID_SAPPHIRE_DJINN_ESSENCE, _
	$ID_WATER_DJINN_ESSENCE, $ID_BRANCH_OF_JUNI_BERRIES, $ID_SENTIENT_SPORE, $ID_HEKET_TONGUE, $ID_DIESSA_CHALICE, $ID_GOLDEN_RIN_RELIC, $ID_DESTROYER_CORE, $ID_INCUBUS_WING, $ID_SAURIAN_BONE, $ID_AMPHIBIAN_TONGUE, $ID_WEAVER_LEG, _
	$ID_PATCH_OF_SIMIAN_FUR, $ID_QUETZAL_CREST, $ID_SKELK_CLAW, $ID_SENTIENT_VINE, $ID_FRIGID_MANDRAGOR_HUSK, $ID_MODNIIR_MANE, $ID_STONE_SUMMIT_EMBLEM, $ID_JOTUN_PELT, $ID_BERSERKER_HORN, $ID_GLACIAL_STONE, $ID_FROZEN_WURM_HUSK, _
	$ID_MOUNTAIN_ROOT, $ID_PILE_OF_ELEMENTAL_DUST, $ID_FIBROUS_MANDRAGOR_ROOT, $ID_SUPERB_CHARR_CARVING, $ID_STONE_GRAWL_NECKLACE, $ID_MANTID_UNGULA, $ID_SKALE_FANG, $ID_STONE_CLAW, $ID_SKELK_FANG, $ID_FUNGAL_ROOT, _
...
Global Const $BONES_TROPHIES_ARRAY[]			= [ $ID_GARGOYLE_SKULL, $ID_SKELETAL_LIMB, _
...
Global Const $RARE_MATERIALS_TROPHIES_ARRAY[]	= [ _
	...
	$ID_GEODE, $ID_SAPPHIRE_DJINN_ESSENCE, $ID_WATER_DJINN_ESSENCE, $ID_ROARING_ETHER_HEART, $ID_RUBY_DJINN_ESSENCE, _
...
Local $rareWeaponsToPickUp = [ _
	...
	_ ; Shields
	$ID_ETERNAL_SHIELD_STRENGTH, $ID_ETERNAL_SHIELD_TACTIC, $ID_ETERNAL_SHIELD_MOTIVATION, $ID_ETERNAL_SHIELD_COMMAND, _
	$ID_EMBLAZONED_DEFENDER, $ID_EXALTED_AEGIS_TACTICS, $ID_EXALTED_AEGIS, _
...
Local $rareWeaponsArray = [ _
	...
	_ ; Shields
	$ID_ETERNAL_SHIELD_STRENGTH, $ID_ETERNAL_SHIELD_TACTIC, $ID_ETERNAL_SHIELD_MOTIVATION, $ID_ETERNAL_SHIELD_COMMAND, _
	$ID_DEMONIC_AEGIS, $ID_DRACONIC_AEGIS, $ID_EMBLAZONED_DEFENDER, $ID_EXALTED_AEGIS_TACTICS, $ID_EXALTED_AEGIS, _
	$ID_AMBER_AEGIS_STRENGTH, $ID_AMBER_AEGIS_TACTICS, $ID_BLADED_SHIELD, $ID_BLADED_SHIELD_2, _
	$ID_ECHOVALD_SHIELD, $ID_ECHOVALD_SHIELD_2, $ID_GOTHIC_DEFENDER, $ID_GOTHIC_DEFENDER_2, $ID_GUARDIAN_OF_THE_HUNT, $ID_GUARDIAN_OF_THE_HUNT_2, _
	$ID_KAPPA_SHIELD, $ID_KAPPA_SHIELD_2, $ID_ORNATE_SHIELD, $ID_PLAGUEBORN_SHIELD, $ID_PLAGUEBORN_SHIELD_2, _
	$ID_OUTCAST_SHIELD, $ID_OUTCAST_SHIELD_2, $ID_SEA_PURSE_SHIELD, _
