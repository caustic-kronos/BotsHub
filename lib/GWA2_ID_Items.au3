...
Global Const $ID_INFINITE_IDENTIFICATION_KIT	= 38620		; Infinite uses
...
Global Const $ID_INFINITE_SALVAGE_KIT			= 38621		; Infinite uses
...
Global Const $ID_PURVEYORS_BELL					= 38626
...
Global Const $GENERAL_ITEMS_ARRAY[]	= [$ID_IDENTIFICATION_KIT, $ID_INFINITE_IDENTIFICATION_KIT, $ID_EXPERT_SALVAGE_KIT, $ID_SALVAGE_KIT, $ID_SALVAGE_KIT_2, $ID_SUPERIOR_IDENTIFICATION_KIT, $ID_SUPERIOR_SALVAGE_KIT, $ID_LOCKPICK]
...
Global Const $ID_ETERNAL_BOW_HORN					= 2496
Global Const $ID_ETERNAL_BOW_LONG					= 2497
Global Const $ID_ETERNAL_BOW_RECURVE				= 2498
Global Const $ID_ETERNAL_BOW_SHORT					= 2499
Global Const $ID_ETERNAL_BOW_FLAT					= 2500
...
Global Const $ID_ETERNAL_SHIELD_STRENGTH			= 332	; Non inscriptible version
Global Const $ID_ETERNAL_SHIELD_TACTICS				= 333	; Non inscriptible version
Global Const $ID_ETERNAL_SHIELD_MOTIVATION			= 860
Global Const $ID_ETERNAL_SHIELD_COMMAND				= 861
Global Const $ID_ETERNAL_SHIELD_TACTICS_2			= 862
Global Const $ID_ETERNAL_SHIELD_STRENGTH_2			= 863
...
Global Const $ID_GHOSTLY_STAFF_INSPIRATION			= 988
Global Const $ID_GHOSTLY_STAFF_SOULREAPING			= 989
Global Const $ID_GHOSTLY_STAFF_ENERGYSTORAGE		= 990
Global Const $ID_GHOSTLY_STAFF_DIVINEFAVOR			= 991
Global Const $ID_GHOSTLY_STAFF_SPAWNINGPOWER		= 992
...
Local $ultraRareWeaponsArray = [ _
	...
	$ID_ETERNAL_BOW, $ID_ETERNAL_BOW_HORN, $ID_ETERNAL_BOW_LONG, $ID_ETERNAL_BOW_RECURVE, $ID_ETERNAL_BOW_SHORT, $ID_ETERNAL_BOW_FLAT, _
	$ID_GHOSTLY_STAFF, $ID_GHOSTLY_STAFF_INSPIRATION, $ID_GHOSTLY_STAFF_SOULREAPING, $ID_GHOSTLY_STAFF_ENERGYSTORAGE, $ID_GHOSTLY_STAFF_DIVINEFAVOR, $ID_GHOSTLY_STAFF_SPAWNINGPOWER, _
	$ID_ETERNAL_SHIELD_STRENGTH, $ID_ETERNAL_SHIELD_TACTICS, $ID_ETERNAL_SHIELD_MOTIVATION, $ID_ETERNAL_SHIELD_COMMAND, $ID_ETERNAL_SHIELD_TACTICS_2, $ID_ETERNAL_SHIELD_STRENGTH_2, _
	_
...
Local $rareWeaponsArray = [ _
	...
	_ ; Bows
	$ID_ETERNAL_BOW, $ID_ETERNAL_BOW_HORN, $ID_ETERNAL_BOW_LONG, $ID_ETERNAL_BOW_RECURVE, $ID_ETERNAL_BOW_SHORT, $ID_ETERNAL_BOW_FLAT, $ID_STORM_BOW, _
	_ ; Focii
	$ID_PAPER_FAN, $ID_PAPER_FAN_2, $ID_PAPER_FAN_3, $ID_PAPER_FAN_4, $ID_PAPER_FAN_5, $ID_PAPER_LANTERN, _
	$ID_JUG, $ID_JUG_2, $ID_JUG_3, $ID_PLAGUEBORN_FOCUS, $ID_PLAGUEBORN_FOCUS_2, $ID_PRONGED_FAN, _
	$ID_STRAW_EFFIGY, _
