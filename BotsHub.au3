...
Global $GUI_Group_RarityLootOptions, _
    $GUI_Checkbox_LootWhiteReq8, $GUI_Checkbox_LootWhiteReq9, $GUI_Checkbox_LootWhiteReq10, _
    $GUI_Checkbox_LootWhiteReq11, $GUI_Checkbox_LootWhiteReq12, $GUI_Checkbox_LootWhiteReq13, _
	$GUI_Checkbox_LootBlueReq8, $GUI_Checkbox_LootBlueReq9, $GUI_Checkbox_LootBlueReq10, _
    $GUI_Checkbox_LootBlueReq11, $GUI_Checkbox_LootBlueReq12, $GUI_Checkbox_LootBlueReq13, _
    $GUI_Checkbox_LootPurpleReq8, $GUI_Checkbox_LootPurpleReq9, $GUI_Checkbox_LootPurpleReq10, _
    $GUI_Checkbox_LootPurpleReq11, $GUI_Checkbox_LootPurpleReq12, $GUI_Checkbox_LootPurpleReq13, _
    $GUI_Checkbox_LootGoldReq8, $GUI_Checkbox_LootGoldReq9, $GUI_Checkbox_LootGoldReq10, _
    $GUI_Checkbox_LootGoldReq11, $GUI_Checkbox_LootGoldReq12, $GUI_Checkbox_LootGoldReq13, _
    $GUI_Checkbox_LootGreenReq9
...
Func createGUI()
	...
	; === Rarity / Req matrix ===
	$GUI_Group_RarityLootOptions = GUICtrlCreateGroup('Rarity / Requirement', 166, 224, 410, 176)
	; Req columns
	GUICtrlCreateLabel('8',  250, 239, 40, 16)
	GUICtrlCreateLabel('9',  290, 239, 40, 16)
	GUICtrlCreateLabel('10', 330, 239, 40, 16)
	GUICtrlCreateLabel('11', 370, 239, 40, 16)
	GUICtrlCreateLabel('12', 410, 239, 40, 16)
	GUICtrlCreateLabel('13', 450, 239, 40, 16)
	; ---- White row ----
	GUICtrlCreateLabel('White items', 176, 259, 60, 16)
	$GUI_Checkbox_LootWhiteReq8  = GUICtrlCreateCheckbox('', 247, 258, 15, 15)
	$GUI_Checkbox_LootWhiteReq9  = GUICtrlCreateCheckbox('', 288, 258, 15, 15)
	$GUI_Checkbox_LootWhiteReq10 = GUICtrlCreateCheckbox('', 330, 258, 15, 15)
	$GUI_Checkbox_LootWhiteReq11 = GUICtrlCreateCheckbox('', 370, 258, 15, 15)
	$GUI_Checkbox_LootWhiteReq12 = GUICtrlCreateCheckbox('', 410, 258, 15, 15)
	$GUI_Checkbox_LootWhiteReq13 = GUICtrlCreateCheckbox('', 450, 258, 15, 15)
	; ---- Blue row ----
	GUICtrlCreateLabel('Blue items', 176, 279, 60, 16)
	$GUI_Checkbox_LootBlueReq8  = GUICtrlCreateCheckbox('', 247, 278, 15, 15)
	$GUI_Checkbox_LootBlueReq9  = GUICtrlCreateCheckbox('', 288, 278, 15, 15)
	$GUI_Checkbox_LootBlueReq10 = GUICtrlCreateCheckbox('', 330, 278, 15, 15)
	$GUI_Checkbox_LootBlueReq11 = GUICtrlCreateCheckbox('', 370, 278, 15, 15)
	$GUI_Checkbox_LootBlueReq12 = GUICtrlCreateCheckbox('', 410, 278, 15, 15)
	$GUI_Checkbox_LootBlueReq13 = GUICtrlCreateCheckbox('', 450, 278, 15, 15)
	; ---- Purple row ----
	GUICtrlCreateLabel('Purple items', 176, 299, 60, 16)
	$GUI_Checkbox_LootPurpleReq8  = GUICtrlCreateCheckbox('', 247, 298, 15, 15)
	$GUI_Checkbox_LootPurpleReq9  = GUICtrlCreateCheckbox('', 288, 298, 15, 15)
	$GUI_Checkbox_LootPurpleReq10 = GUICtrlCreateCheckbox('', 330, 298, 15, 15)
	$GUI_Checkbox_LootPurpleReq11 = GUICtrlCreateCheckbox('', 370, 298, 15, 15)
	$GUI_Checkbox_LootPurpleReq12 = GUICtrlCreateCheckbox('', 410, 298, 15, 15)
	$GUI_Checkbox_LootPurpleReq13 = GUICtrlCreateCheckbox('', 450, 298, 15, 15)
	; ---- Gold row ----
	GUICtrlCreateLabel('Gold items', 176, 319, 60, 16)
	$GUI_Checkbox_LootGoldReq8  = GUICtrlCreateCheckbox('', 247, 318, 15, 15)
	$GUI_Checkbox_LootGoldReq9  = GUICtrlCreateCheckbox('', 288, 318, 15, 15)
	$GUI_Checkbox_LootGoldReq10 = GUICtrlCreateCheckbox('', 330, 318, 15, 15)
	$GUI_Checkbox_LootGoldReq11 = GUICtrlCreateCheckbox('', 370, 318, 15, 15)
	$GUI_Checkbox_LootGoldReq12 = GUICtrlCreateCheckbox('', 410, 318, 15, 15)
	$GUI_Checkbox_LootGoldReq13 = GUICtrlCreateCheckbox('', 450, 318, 15, 15)

	; ---- Green row ---- (only Req 9)
	GUICtrlCreateLabel('Green items', 176, 339, 60, 16)
	$GUI_Checkbox_LootGreenReq9 = GUICtrlCreateCheckbox('', 288, 338, 15, 15)
	;GUICtrlCreateGroup('', -99, -99, 1, 1)

	$GUI_Group_FarmSpecificLootOptions = GUICtrlCreateGroup('Farm Specific', 23, 224, 136, 176)
	$GUI_Checkbox_LootGlacialStones = GUICtrlCreateCheckbox('Glacial Stones', 31, 249, 110, 20)
	...
	$GUI_Group_ConsumablesLootOption = GUICtrlCreateGroup('Consumables loot', 306, 39, 271, 176)
	...
	GUICtrlSetState($GUI_Checkbox_LootWhiteReq8,  $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootWhiteReq9,  $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootWhiteReq10, $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootWhiteReq11, $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootWhiteReq12, $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootWhiteReq13, $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootBlueReq8,  $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootBlueReq9,  $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootBlueReq10, $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootBlueReq11, $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootBlueReq12, $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootBlueReq13, $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootPurpleReq8,  $GUI_CHECKED)
	GUICtrlSetState($GUI_Checkbox_LootPurpleReq9,  $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootPurpleReq10,  $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootPurpleReq11,  $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootPurpleReq12,  $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootPurpleReq13,  $GUI_UNCHECKED)
	GUICtrlSetState($GUI_Checkbox_LootGoldReq8,  $GUI_CHECKED)
	GUICtrlSetState($GUI_Checkbox_LootGoldReq9,  $GUI_CHECKED)
	GUICtrlSetState($GUI_Checkbox_LootGoldReq10, $GUI_CHECKED)
	GUICtrlSetState($GUI_Checkbox_LootGoldReq11, $GUI_CHECKED)
	GUICtrlSetState($GUI_Checkbox_LootGoldReq12, $GUI_CHECKED)
	GUICtrlSetState($GUI_Checkbox_LootGoldReq13, $GUI_CHECKED)
	GUICtrlSetState($GUI_Checkbox_LootGreenReq9, $GUI_CHECKED)
...
Func WriteConfigToJson()
    ...
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.white.req8',  GUICtrlRead($GUI_Checkbox_LootWhiteReq8)  == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.white.req9',  GUICtrlRead($GUI_Checkbox_LootWhiteReq9)  == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.white.req10', GUICtrlRead($GUI_Checkbox_LootWhiteReq10) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.white.req11', GUICtrlRead($GUI_Checkbox_LootWhiteReq11) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.white.req12', GUICtrlRead($GUI_Checkbox_LootWhiteReq12) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.white.req13', GUICtrlRead($GUI_Checkbox_LootWhiteReq13) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.blue.req8',  GUICtrlRead($GUI_Checkbox_LootBlueReq8)  == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.blue.req9',  GUICtrlRead($GUI_Checkbox_LootBlueReq9)  == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.blue.req10', GUICtrlRead($GUI_Checkbox_LootBlueReq10) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.blue.req11', GUICtrlRead($GUI_Checkbox_LootBlueReq11) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.blue.req12', GUICtrlRead($GUI_Checkbox_LootBlueReq12) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.blue.req13', GUICtrlRead($GUI_Checkbox_LootBlueReq13) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.purple.req8',  GUICtrlRead($GUI_Checkbox_LootPurpleReq8)  == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.purple.req9',  GUICtrlRead($GUI_Checkbox_LootPurpleReq9)  == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.purple.req10', GUICtrlRead($GUI_Checkbox_LootPurpleReq10) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.purple.req11', GUICtrlRead($GUI_Checkbox_LootPurpleReq11) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.purple.req12', GUICtrlRead($GUI_Checkbox_LootPurpleReq12) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.purple.req13', GUICtrlRead($GUI_Checkbox_LootPurpleReq13) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.gold.req8',  GUICtrlRead($GUI_Checkbox_LootGoldReq8)  == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.gold.req9',  GUICtrlRead($GUI_Checkbox_LootGoldReq9)  == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.gold.req10', GUICtrlRead($GUI_Checkbox_LootGoldReq10) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.gold.req11', GUICtrlRead($GUI_Checkbox_LootGoldReq11) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.gold.req12', GUICtrlRead($GUI_Checkbox_LootGoldReq12) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.gold.req13', GUICtrlRead($GUI_Checkbox_LootGoldReq13) == 1)
    _JSON_addChangeDelete($jsonObject, 'loot.req_matrix.green.req9', GUICtrlRead($GUI_Checkbox_LootGreenReq9) == 1)
...
Func ReadConfigFromJson($jsonString)
    ...
    GUICtrlSetState($GUI_Checkbox_LootWhiteReq8,  _JSON_Get($jsonObject, 'loot.req_matrix.white.req8')  ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootWhiteReq9,  _JSON_Get($jsonObject, 'loot.req_matrix.white.req9')  ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootWhiteReq10, _JSON_Get($jsonObject, 'loot.req_matrix.white.req10') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootWhiteReq11, _JSON_Get($jsonObject, 'loot.req_matrix.white.req11') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootWhiteReq12, _JSON_Get($jsonObject, 'loot.req_matrix.white.req12') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootWhiteReq13, _JSON_Get($jsonObject, 'loot.req_matrix.white.req13') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootBlueReq8,  _JSON_Get($jsonObject, 'loot.req_matrix.blue.req8')  ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootBlueReq9,  _JSON_Get($jsonObject, 'loot.req_matrix.blue.req9')  ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootBlueReq10, _JSON_Get($jsonObject, 'loot.req_matrix.blue.req10') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootBlueReq11, _JSON_Get($jsonObject, 'loot.req_matrix.blue.req11') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootBlueReq12, _JSON_Get($jsonObject, 'loot.req_matrix.blue.req12') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootBlueReq13, _JSON_Get($jsonObject, 'loot.req_matrix.blue.req13') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootPurpleReq8,  _JSON_Get($jsonObject, 'loot.req_matrix.purple.req8')  ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootPurpleReq9,  _JSON_Get($jsonObject, 'loot.req_matrix.purple.req9')  ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootPurpleReq10, _JSON_Get($jsonObject, 'loot.req_matrix.purple.req10') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootPurpleReq11, _JSON_Get($jsonObject, 'loot.req_matrix.purple.req11') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootPurpleReq12, _JSON_Get($jsonObject, 'loot.req_matrix.purple.req12') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootPurpleReq13, _JSON_Get($jsonObject, 'loot.req_matrix.purple.req13') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootGoldReq8,  _JSON_Get($jsonObject, 'loot.req_matrix.gold.req8')  ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootGoldReq9,  _JSON_Get($jsonObject, 'loot.req_matrix.gold.req9')  ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootGoldReq10, _JSON_Get($jsonObject, 'loot.req_matrix.gold.req10') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootGoldReq11, _JSON_Get($jsonObject, 'loot.req_matrix.gold.req11') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootGoldReq12, _JSON_Get($jsonObject, 'loot.req_matrix.gold.req12') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootGoldReq13, _JSON_Get($jsonObject, 'loot.req_matrix.gold.req13') ? $GUI_CHECKED : $GUI_UNCHECKED)
    GUICtrlSetState($GUI_Checkbox_LootGreenReq9, _JSON_Get($jsonObject, 'loot.req_matrix.green.req9') ? $GUI_CHECKED : $GUI_UNCHECKED)
